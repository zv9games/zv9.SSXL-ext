...
pub(super) mod re_export {
    ...
    impl AudioListener3D {
        ...
        pub fn set_doppler_tracking(&mut self, mode: crate::classes::audio_listener_3d::DopplerTracking,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioListener3D", "set_doppler_tracking", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_doppler_tracking(&self,) -> crate::classes::audio_listener_3d::DopplerTracking {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioListener3D", "get_doppler_tracking", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AudioListener3D {
        ...
        fn class_id() -> ClassId {
            ...
            let name: &'static ClassId = CLASS_ID.get_or_init(|| ClassId::__alloc_next_ascii(c"AudioListener3D"));
            * name
        }
