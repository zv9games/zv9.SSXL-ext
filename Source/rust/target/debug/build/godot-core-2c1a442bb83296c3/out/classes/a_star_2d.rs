...
pub(super) mod re_export {
    ...
    impl AStar2D {
        ...
        pub fn set_neighbor_filter_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "set_neighbor_filter_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_neighbor_filter_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "is_neighbor_filter_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AStar2D {
        ...
        fn class_id() -> ClassId {
            ...
            let name: &'static ClassId = CLASS_ID.get_or_init(|| ClassId::__alloc_next_ascii(c"AStar2D"));
            * name
        }
