...
pub(super) mod re_export {
    ...
    impl OpenXrExtensionWrapper {
        pub fn get_openxr_api(&mut self,) -> Option < Gd < crate::classes::OpenXrApiExtension > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrExtensionWrapper", "get_openxr_api", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn register_extension_wrapper(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrExtensionWrapper", "register_extension_wrapper", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for OpenXrExtensionWrapper {
        ...
        fn class_id() -> ClassId {
            ...
            let name: &'static ClassId = CLASS_ID.get_or_init(|| ClassId::__alloc_next_ascii(c"OpenXRExtensionWrapper"));
            * name
        }
