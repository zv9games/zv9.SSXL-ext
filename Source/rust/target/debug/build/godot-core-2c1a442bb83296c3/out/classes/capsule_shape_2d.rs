...
pub(super) mod re_export {
    ...
    impl CapsuleShape2D {
        ...
        pub fn set_mid_height(&mut self, mid_height: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CapsuleShape2D", "set_mid_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mid_height(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CapsuleShape2D", "get_mid_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for CapsuleShape2D {
        ...
        fn class_id() -> ClassId {
            ...
            let name: &'static ClassId = CLASS_ID.get_or_init(|| ClassId::__alloc_next_ascii(c"CapsuleShape2D"));
            * name
        }
