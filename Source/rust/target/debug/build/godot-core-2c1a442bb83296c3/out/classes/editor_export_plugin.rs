...
pub(super) mod re_export {
    ...
    impl EditorExportPlugin {
        ...
        pub fn add_apple_embedded_platform_project_static_lib(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_apple_embedded_platform_project_static_lib", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_apple_embedded_platform_framework(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_apple_embedded_platform_framework", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_apple_embedded_platform_embedded_framework(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_apple_embedded_platform_embedded_framework", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_apple_embedded_platform_plist_content(&mut self, plist_content: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_apple_embedded_platform_plist_content", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_apple_embedded_platform_linker_flags(&mut self, flags: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_apple_embedded_platform_linker_flags", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_apple_embedded_platform_bundle_file(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_apple_embedded_platform_bundle_file", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_apple_embedded_platform_cpp_code(&mut self, code: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_apple_embedded_platform_cpp_code", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for EditorExportPlugin {
        ...
        fn class_id() -> ClassId {
            ...
            let name: &'static ClassId = CLASS_ID.get_or_init(|| ClassId::__alloc_next_ascii(c"EditorExportPlugin"));
            * name
        }
