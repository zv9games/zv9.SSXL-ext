...
pub(super) mod re_export {
    ...
    impl ZipReader {
        ...
        pub(crate) fn get_compression_level_full(&mut self, path: CowArg < GString >, case_sensitive: bool,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ZipReader", "get_compression_level", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for ZipReader {
        ...
        fn class_id() -> ClassId {
            ...
            let name: &'static ClassId = CLASS_ID.get_or_init(|| ClassId::__alloc_next_ascii(c"ZIPReader"));
            * name
        }
